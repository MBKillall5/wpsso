...
@Setter
@NoArgsConstructor
public class WordpressRoleModel implements RoleModel {
    ...
    public WordpressRoleModel(String id, String name, String description, boolean composite, RoleContainerModel roleContainer) {
        this.id = id;
        this.name = name;
